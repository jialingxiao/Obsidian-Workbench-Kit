...
块的垂直行为是**放哪就是哪**：拖到哪儿就停在哪儿，块之间允许留空白，别的块只在被压住时才让开。反过来那种「自动向上压紧、永不留洞」看着整齐，代价是你根本没法把块放在中间 —— 最上面的往下拖会弹回去，下面的往上拖会一路冲顶，整页的紧凑是算法说了算不是你说了算。想要紧凑排版时点工具栏的「⇅ 整理」手动压一次（可撤销）。
